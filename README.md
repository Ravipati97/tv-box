...
- **Track episodes** — mark episodes watched as you go; the show page shows your progress (e.g. "12/24 watched"), and in-progress shows automatically show up on Home until you finish them. Haven't started yet? "Start watching" on the show page adds it to Now Watching right away. Marking an episode from a while back instead of just now? "Watched in the past" next to it lets you pick the real date.
...
- **Profile** — stats, a day-by-day Diary of everything you've rated, and the same sortable History tab as Home (tap a show for your watch history on it).
